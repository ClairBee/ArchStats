...
\centering
\caption{Histograms of raw angles $\boldsymbol{\phi}$ and transformed angles $\boldsymbol{\theta}$, with kernel density estimate (bandwidth 50). Where appropriate, densities of maximum-likelihood candidate models are overlaid; the legend is common to both representations of $\boldsymbol{\theta}$.
}
%
