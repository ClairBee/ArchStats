...
\todo{von Mises second trigonometric moments: bother to put them in?}
...
\todo{Check `get orientation' function (and anything else involving angles). atan2 should always measure from the 0 $x$-axis, but I suspect this is not the case here.}
