...
plot(crop1, col = "grey", asp = T, xlim = c(xmin(ext), xmax(ext)), ylim = c(ymin(ext), ymax(ext)), legend = F, main = "Original feature", cex.main = 3, xaxt = "none", yaxt = "none")
...
plot(crop1, col = "grey", asp = T, xlim = c(xmin(ext), xmax(ext)), ylim = c(ymin(ext), ymax(ext)), legend = F, main = "Dilation", cex.main = 3, xaxt = "none", yaxt = "none")
abline(v = seq(from = xmin(ext) - r/2, to = xmax(ext) + r/2, by = r), col = "black", lty = 3)
abline(h = seq(from = ymin(ext) - (3*r/2), to = ymax(ext) + (3*r/2), by = r), col = "black", lty = 3)
...
plot(crop1, col = "grey", asp = T, xlim = c(xmin(ext), xmax(ext)), ylim = c(ymin(ext), ymax(ext)), legend = F, main = "Erosion", cex.main = 3, xaxt = "none", yaxt = "none")
plot(dilated, add = T)
abline(v = seq(from = xmin(ext) - r/2, to = xmax(ext) + r/2, by = r), col = "black", lty = 3)
abline(h = seq(from = ymin(ext) - (3*r/2), to = ymax(ext) + (3*r/2), by = r), col = "black", lty = 3)
